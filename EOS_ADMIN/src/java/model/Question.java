...
public class Question {
    ...
    public Question(String question, String a1, String a2, String a3, String a4, String correctA,int sid) {
    ...
    public Question(int questionNo, String question, String a1, String a2, String a3, String a4) {
    ...
    public Question(int questionNo, String question, String a1, String a2, String a3, String a4, String correctA) {
        this.questionNo = questionNo;
        this.question = question;
        this.a1 = a1;
        this.a2 = a2;
    ...
    public ArrayList<Question> getListQuestion() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Question p = new Question(id, question, a1, a2, a3, a4);
                data.add(p);
            }
        } catch (Exception e) {
    ...
    public ArrayList<Question> getListQuestionReverse() {
        ArrayList<Question> data = new ArrayList<Question>();
        try {
            String strSelect = "SELECT [QuestionNO]\n"
                    + "      ,[Question]\n"
    ...
    public ArrayList<Question> getListQuestionPRJ() {
        ArrayList<Question> data = new ArrayList<Question>();
        try {
            String strSelect = "SELECT [QuestionNO]\n"
                    + "      ,[Question]\n"
    ...
    public ArrayList<Question> getListQuestionRandomPRJ() {
        ArrayList<Question> data = new ArrayList<Question>();
        try {
            String strSelect = "SELECT [QuestionNO]\n"
                    + "      ,[Question]\n"
    ...
    public ArrayList<Question> getListQuestionMAS() {
        ArrayList<Question> data = new ArrayList<Question>();
        try {
            String strSelect = "SELECT [QuestionNO]\n"
                    + "      ,[Question]\n"
    ...
    //SavePRJ301Controller
    public ArrayList<Question> getListQuestionRandomMAS() {
        ArrayList<Question> data = new ArrayList<Question>();
        try {
            String strSelect = "SELECT [QuestionNO]\n"
                    + "      ,[Question]\n"
    ...
    public ArrayList<Question> getListQuestionIOT() {
        ArrayList<Question> data = new ArrayList<Question>();
        try {
            String strSelect = "SELECT [QuestionNO]\n"
                    + "      ,[Question]\n"
